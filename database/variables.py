names = [
    "Afonso", "Alexandre", "Alice", "Ana", "André", 
    "António", "Beatriz", "Bernardo", "Bruna", "Carla", 
    "Carlos", "Catarina", "Cláudia", "Cristina", "Daniel", 
    "David", "Diana", "Diogo", "Eduardo", "Elisa", 
    "Emanuel", "Fábio", "Fernanda", "Francisco", "Gabriel", 
    "Gonçalo", "Helena", "Henrique", "Inês", "Isabel", 
    "Joana", "João", "Jorge", "José", "Laura", 
    "Leonor", "Luís", "Madalena", "Manuel", "Margarida", 
    "Maria", "Mariana", "Martim", "Matilde", "Miguel", 
    "Nuno", "Patrícia", "Pedro", "Rafael", "Ricardo"
]

surnames = [
    "Almeida", "Alves", "Amaral", "Andrade", "Araújo",
    "Barbosa", "Barros", "Bastos", "Batista", "Borges",
    "Braga", "Campos", "Cardoso", "Carvalho", "Castro",
    "Coelho", "Costa", "Cruz", "Dias", "Duarte",
    "Esteves", "Fernandes", "Ferreira", "Figueiredo", "Freitas",
    "Gomes", "Gonçalves", "Guimarães", "Henriques", "Lima",
    "Lopes", "Machado", "Macedo", "Martins", "Matias",
    "Mendes", "Miranda", "Monteiro", "Moraes", "Moreira",
    "Neves", "Nogueira", "Oliveira", "Pereira", "Pimentel",
    "Pinto", "Ramos", "Ribeiro", "Rocha", "Silva",
    "Sousa", "Teixeira", "Vieira"
]

symptoms = [
    ("Fatigue", "A feeling of extreme tiredness or lack of energy, often making it difficult to carry out daily tasks."),
    ("Breathlessness", "A feeling of shortness of breath or difficulty breathing, which can be caused by various health conditions."),
    ("Dizziness", "A sensation of lightheadedness, unsteadiness, or a feeling that you or your surroundings are spinning."),
    ("Chest Pain", "A discomfort or pain in the chest area, which can vary from a sharp or stabbing sensation to a pressure-like feeling.")
]
